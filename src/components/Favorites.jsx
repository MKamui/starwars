  ...
  return (
    <div>
      ...
      <div className='flex space-x-4 justify-center mt-14'>
        ...
        <input className='text-black w-60' type='text' placeholder='Search...' onChange={(e) => handleChange(e)}/>
      </div>
      ...
      <div className='w-4/5 h-30 flex flex-col m-10 border-2 border-yellow-400 rounded-lg'>
        <h1 className='text-xl m-2 underline'>{character.name}</h1>
        <div className='flex items-center mx-2 my-1'>
          <BsGenderAmbiguous size={20} className='mr-2'/>
          <h2 className='text-lg'>{character.gender}</h2>
